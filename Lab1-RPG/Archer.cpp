...
Archer::Archer(std::string archerName, int archerHP, int archerStrenght, int archerSpeed, int archerMagic):Fighter(archerName, archerHP, archerStrenght, archerSpeed, archerMagic)
{
    originalSpeed = archerSpeed;
}
